...
```{r}
Counties<-c("Jefferson", "St. Lawrence","Franklin", "Clinton", "Essex", "Hamilton", "Lewis" )
Area<-c(1857,2821,1697,1118,1916,1808,1290)
Pop<-c(111755, 108047,50293,80695,37300,4434,26447)
